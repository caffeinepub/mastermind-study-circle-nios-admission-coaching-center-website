...
import type { PageContent as _PageContent, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllPages(): Promise<Array<[string, PageContent]>> {
        if (this.processError) {
            try {
    ...
    async getHomePage(): Promise<PageContent> {
        if (this.processError) {
            try {
    ...
    async getPage(arg0: string): Promise<PageContent | null> {
        if (this.processError) {
            try {
    ...
    async getPages(arg0: Array<string>): Promise<Array<[string, PageContent]>> {
        if (this.processError) {
            try {
    ...
    async removePage(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updatePage(arg0: string, arg1: PageContent): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PageContent]): PageContent | null {
